...
pub fn day_15_push_nothing_test() {
  let map =
    [
      "##################################################",
      "#................................................#",
  ...
  let up = Coord(-1, 0)
  let map = day_15.move_robot(map, up)

  map
  |> day_15.map_to_string
  |> should.equal(expected_map)
}

pub fn day_15_push_box_test() {
  let map =
    [
      "##################################################",
      "#................................................#",
...
pub fn day_15_push_boxes_against_wall_test() {
  let map =
    [
      "##################################################",
      "#................................................#",
  ...
  let right = Coord(0, 1)
  let map = day_15.move_robot(map, right)
...
pub fn day_15_expanded_map_push_test() {
  let map =
    [
      "###########", "#.........#", "#.....O...#", "#.....OO@.#", "#.........#",
      "###########",
  ...
  map
  |> day_15.move_robot(move)
  |> day_15.map_to_string
  |> string.split("\n")
  |> should.equal(expected_map)
}

pub fn day_15_expanded_map_push_vertically_test() {
  let map =
    [
      "###########", "#.........#", "#.....O...#", "#.....OO@.#", "#.........#",
      "###########",
  ...
  let map = {
    use map, move <- list.fold(moves, day_15.expand_map(map))
    day_15.move_robot(map, move)
  }
